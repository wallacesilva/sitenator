...
class BaseController
{
    ...
    public function setTemplateDefault($name)
    {   
        $this->template_default = $name;
        $this->data['template_url'] = $this->data['baseUrl'].'templates/'.$this->template_default;
        $this->app->config('templates.path', PUBLIC_PATH.'templates/'.$this->template_default.'/'); 
        ...
        // After instantiation
        //$view = $this->app->view();
        //$view->setTemplatesDirectory(PUBLIC_PATH.'templates/'.$this->template_default.'/');
    }
